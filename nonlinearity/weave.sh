...
data_path=/volume/pt-train/users/ztgao/loop_arcagi/data/arc-aug-1000 \
...
+ema=True > /volume/pt-train/users/ztgao/loop_arcagi/nonlinearity/weave.log 2>&1 &